/**
 * 该组件来自 https://github.com/bibidu/zhihu-card-animate-component
 */
...
export default class CardScrollAnimate extends React.PureComponent {
  constructor(props) {
    ...
    this.COVER_CONTAINER_SCALE =
      props.coverContainerScale || COVER_CONTAINER_SCALE;
  ...
  onTouchMove = (e, key) => {
    if (this.isLock() || !this.isValidScrollKey(key) || !this.isMoveValid())
      return;
      ...
      <div className="card-scroll-animate-container">
        {childA && (
          <div
            ...
            onMouseDown={(e) =>
              this.onTouchStart({ touches: [{ clientX: e.pageX }] }, "A")
            }
            onMouseMove={(e) =>
              this.onTouchMove({ touches: [{ clientX: e.pageX }] }, "A")
            }
            onMouseUp={(e) => this.onTouchEnd(null, "A")}
          >
            {React.cloneElement(childA, {
              onToggleNext: () => this.onToggleNext("A"),
            })}
          </div>
        )}
        ...
        {childB && (
          <div
            ...
            onMouseDown={(e) =>
              this.onTouchStart({ touches: [{ clientX: e.pageX }] }, "B")
            }
            onMouseMove={(e) =>
              this.onTouchMove({ touches: [{ clientX: e.pageX }] }, "B")
            }
            onMouseUp={(e) => this.onTouchEnd(null, "B")}
          >
            {React.cloneElement(childB, {
              onToggleNext: () => this.onToggleNext("B"),
            })}
          </div>
        )}
      </div>
